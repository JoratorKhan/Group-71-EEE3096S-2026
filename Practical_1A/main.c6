...
static void GPIO_Init(void)
{
    ...
    GPIOB->MODER |= (1U << (4*2)); // set PB4 to output mode
    GPIOB->OTYPER &= ~(GPIO_OTYPER_OT_4); // set PB4 to push-pull mode
    GPIOB->OSPEEDR |= (3U << (4*2)); // set PB4 to high-speed mode
